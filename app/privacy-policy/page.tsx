      ...
      <div className="min-h-screen bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4 py-12">
          <div className="prose max-w-none">
            <h1 className="text-4xl font-bold text-center mb-12 text-black dark:text-white">PRIVACY POLICY</h1>
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4 text-black dark:text-gray-300">
                <p>Welcome to {config.siteInfo.companyName}! This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website {config.siteInfo.siteUrl}, including any other media form, media channel, mobile website, or mobile application related or connected thereto (collectively, the "Site").</p>
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">2. Definitions</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
                <p><b>SERVICE</b> means the <b>{config.siteInfo.siteUrl}</b> website operated by {config.siteInfo.companyName}.</p>
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">3. Information Collection and Use</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">4. Types of Data Collected</h3>
              <div className="space-y-6 text-black dark:text-gray-300">
                <div className="space-y-4">
                  <h4 className="text-xl font-semibold text-black dark:text-white">Personal Data</h4>
                ...
                <div className="space-y-4">
                  <h4 className="text-xl font-semibold text-black dark:text-white">Usage Data</h4>
                ...
                <div className="space-y-4">
                  <h4 className="text-xl font-semibold text-black dark:text-white">Tracking Cookies Data</h4>
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">5. Use of Data</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
                <p>wackyflip uses the collected data for various purposes:</p>
                <ul className="list-disc pl-6 space-y-2 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">6. Retention of Data</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">7. Transfer of Data</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">8. Disclosure of Data</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">9. Security of Data</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
                <p>If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.</p>
                <p>We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
                <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>{config.siteInfo.email}</b>.</p>
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
                ...
                <ul className="list-disc pl-6 space-y-2 text-black dark:text-gray-300">
                  ...
                  <li>0.4. users are able to change their personal information by emailing us at <b>{config.siteInfo.email}</b>.</li>
                </ul>
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
                <p>If you are a California resident, you are entitled to learn what data we collect about you, ask to delete your data and not to sell (share) it. To exercise your data protection rights, you can make certain requests and ask us:</p>
                <ul className="list-disc pl-6 space-y-2 text-black dark:text-gray-300">
                  <li><b>0.1. What personal information we have about you. If you make this request, we will return to you:</b></li>
                ...
                <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>{config.siteInfo.email}</b>.</p>
                <p>Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.</p>
              </div>
            </section>

            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">13. Service Providers</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">14. Analytics</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">15. CI/CD tools</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">16. Advertising</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">17. Behavioral Remarketing</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">18. Links to Other Sites</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">19. Children's Privacy</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">20. Changes to This Privacy Policy</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
            ...
            <section className="space-y-6">
              <h3 className="text-2xl font-bold text-black dark:text-white">Contact Us</h3>
              <div className="space-y-4 text-black dark:text-gray-300">
                <p>If you have questions or comments about this Privacy Policy, please email us at: <b>{config.siteInfo.email}</b></p>
              </div>
            </section>
